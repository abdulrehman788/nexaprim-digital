      ...
      <div
        ...
        style={{
          backgroundImage: [
            ...
            "radial-gradient(1.5px 1.5px at 160px 60px, rgba(139,92,246,0.45), transparent)",
            "radial-gradient(1px 1px at 220px 180px, rgba(255,255,255,0.4), transparent)",
            "radial-gradient(1px 1px at 310px 90px, rgba(167,139,250,0.35), transparent)",
            "radial-gradient(1.5px 1.5px at 420px 140px, rgba(255,255,255,0.45), transparent)",
            "radial-gradient(1px 1px at 520px 40px, rgba(139,92,246,0.3), transparent)",
            ...
            "radial-gradient(1.5px 1.5px at 880px 160px, rgba(167,139,250,0.3), transparent)",
          ].join(", "),
