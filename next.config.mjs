...
const nextConfig = {
  ...
  images: {
    ...
    // Fewer widths → fewer optimizer variants if anything still hits /_next/image
    ...
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          ...
          "font-src 'self'",
          "connect-src 'self' ws: wss: https://cal.com https://*.cal.com https://calendly.com https://*.calendly.com",
